...
from core.pipelines.polymarket_rss_flux import (
    PolymarketRSSFlux,
    RSSFluxConfig,
...
def rss_flux_instance(mock_workforce, mock_api_client, rss_flux_config):
    """Create a PolymarketRSSFlux instance for testing."""
...
class TestPolymarketRSSFluxInitialization:
    """Test PolymarketRSSFlux initialization."""
